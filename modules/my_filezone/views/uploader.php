<h1><?= $headline ?></h1>
<p>You can Order or Upload your pictures here. When finish,  click on 'GO BACK' or CLick here to ORDER. <a href="<?= BASE_URL ?>pictures/order_pictures/<?= $target_module ?>/<?= $update_id ?>"><button class="button"><i class="fa fa-arrow-right"></i> ORDER PICTURES</button></a> </p>  
<p><?php 
