...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('notice_sources/manage', 'View All Notice Sources', array("class" => "button alt"));
        echo anchor('notice_sources/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="three-col">
    <div class="card record-details">
        ...
        <div class="card-body">
            <div><span>Source Name</span><span><?= $source_name ?></span></div>
            <div><span>Author</span><span><?= $author ?></span></div>
            <div><span>Source Link</span><span><?= $source_link ?></span></div>
        </div>
    </div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('notice_sources/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Notice Source record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
