<h1><?= $headline ?></h1>
<p>Use esta página para subir sus imágenes.  Cuando finalice, puede hacer click para ir a 'Ordenar las Fotos' o 'GO BACK'.</p>  
<p><?php 
$btn_attr['class'] = 'button';
echo anchor($previous_url, '<i class="fa fa-arrow-left"></i> GO BACK', $btn_attr) ?>
<a href="<?= BASE_URL ?>pictures/order_pictures/<?= $target_module ?>/<?= $update_id ?>"><button class="button alt"><i class="fa fa-pencil"></i> ORDER PICTURES</button></a></p>
<div class="drop-zone" id="drop-zone">
    ...
    <div id="controls">
        <span class="drop-zone__prompt">
            Drag &amp; Drop sus fotos acá o haga click '<span class="browse" onclick="initBrowse()">Browse</span>'
        </span>
